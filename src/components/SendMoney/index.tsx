export const SendMoney = () => {
    ...
    return (<div className="py-16 bg-gray-50 overflow-hidden lg:py-24">
    <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
      ...
      <div className="relative">
        <h2 className="text-center text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
          Keep more of your earnings every day
        </h2>
        <p className="mt-4 max-w-3xl mx-auto text-center text-xl text-gray-500">
        Webpay charges only 0.03% per transaction processed. Say goodbye to 3% merchant fees.
        </p>
      </div>
      ...
      <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
        <div className="relative">
          <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight sm:text-3xl">
            Accept payments from anywhere, in moments
          </h3>
          <p className="mt-3 text-lg text-gray-500">
            Customers can pay you in any token that they'd like. You always get paid in stablecoins.
          </p>
          ...
          <dl className="mt-10 space-y-10">
            <div className="relative">
              <dt>
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Competitive swap rates</p>
              </dt>
              <dd className="mt-2 ml-16 text-base text-gray-500">
                Swaps are done directly with major DEX's like Serum to ensure customers are paying minimal fees to transact with you.
              </dd>
            </div>
            ...
            <div className="relative">
              ...
              <dd className="mt-2 ml-16 text-base text-gray-500">
                With a flat 0.03% fee per transaction, taking payments with Webpay is 100x better than leading credit or debit card networks.
              </dd>
            </div>
            ...
            <div className="relative">
              ...
              <dd className="mt-2 ml-16 text-base text-gray-500">
                We auto-deposit funds into your wallet after we receive them so your money stays in your control.
              </dd>
            </div>
          </dl>
        </div>
